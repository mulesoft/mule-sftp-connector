 ...
 * send a CONNECT request. The request is consumed, a 200 OK answer is returned, and then it acts as a tunnel between the client
 * and the provided localhost target port. If stopped will close active threads and connectionHandlers.
 *
