...
public class SftpCopyTestCase extends CommonSftpConnectorTestCase {
  ...
  public SftpCopyTestCase(String name, SftpTestHarness testHarness, String ftpConfigFile) {
    super(name, testHarness, ftpConfigFile);
  }

  @Override
  protected String getConfigFile() {
    return "sftp-copy-config.xml";
  }
  ...
  public void overwriteInSameDirectory() throws Exception {
    final String existingFileName = "existing.txt";
