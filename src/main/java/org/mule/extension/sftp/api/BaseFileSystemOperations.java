...
import org.mule.extension.sftp.api.subset.SubsetList;
...
public abstract class BaseFileSystemOperations {
   ...
   */
  @Deprecated
  protected List<Result<InputStream, org.mule.extension.sftp.api.FileAttributes>> doList(org.mule.extension.sftp.api.FileConnectorConfig config,
                                                                                         org.mule.extension.sftp.api.FileSystem fileSystem,
   ...
   * @throws IllegalArgumentException if {@code directoryPath} points to a file which doesn't exist or is not a directory
   */
  protected PagingProvider<org.mule.extension.sftp.api.FileSystem, Result<CursorProvider, org.mule.extension.sftp.api.FileAttributes>> doPagedList(org.mule.extension.sftp.api.FileConnectorConfig config,
                                                                                                                                                   String directoryPath,
                                                                                                                                                   boolean recursive,
                                                                                                                                                   FileMatcher matchWith,
                                                                                                                                                   Long timeBetweenSizeCheck,
  ...
  protected PagingProvider<org.mule.extension.sftp.api.FileSystem, Result<CursorProvider, org.mule.extension.sftp.api.FileAttributes>> doPagedList(org.mule.extension.sftp.api.FileConnectorConfig config,
    ...
    return new PagingProvider<org.mule.extension.sftp.api.FileSystem, Result<CursorProvider, org.mule.extension.sftp.api.FileAttributes>>() {
      ...
      @Override
      public List<Result<CursorProvider, org.mule.extension.sftp.api.FileAttributes>> getPage(org.mule.extension.sftp.api.FileSystem connection) {
      ...
      private void initializePagingProvider(org.mule.extension.sftp.api.FileSystem connection) {
      ...
      @Override
      public java.util.Optional<Integer> getTotalResults(org.mule.extension.sftp.api.FileSystem connection) {
        return java.util.Optional.of(files.size());
      }

      @Override
      public void close(org.mule.extension.sftp.api.FileSystem connection) throws MuleException {}
   ...
   *
   * @param config     the config that is parameterizing this operation
   * @param fileSystem a reference to the host {@link org.mule.extension.sftp.api.FileSystem}
   ...
   */
  @Deprecated
  protected Result<InputStream, org.mule.extension.sftp.api.FileAttributes> doRead(@Config org.mule.extension.sftp.api.FileConnectorConfig config,
                                                                                   @Connection org.mule.extension.sftp.api.FileSystem fileSystem,
  ...
  /**
   * @deprecated {@link #doWrite(org.mule.extension.sftp.api.FileConnectorConfig, org.mule.extension.sftp.api.FileSystem, String, InputStream, boolean, boolean, org.mule.extension.sftp.api.FileWriteMode)}
   ...
   *
   * @param config                  the {@link org.mule.extension.sftp.api.FileConnectorConfig} on which the operation is being
   *                                executed
   * @param fileSystem              a reference to the host {@link org.mule.extension.sftp.api.FileSystem}
   ...
   *                                {@link org.mule.extension.sftp.api.FileConnectorConfig#getDefaultWriteEncoding()}
   ...
   */
  @Deprecated
  protected void doWrite(org.mule.extension.sftp.api.FileConnectorConfig config,
                         org.mule.extension.sftp.api.FileSystem fileSystem, String path, InputStream content, String encoding,
                         boolean createParentDirectories, boolean lock, org.mule.extension.sftp.api.FileWriteMode mode) {
    if (content == null) {
   ...
   */
  protected void doWrite(org.mule.extension.sftp.api.FileConnectorConfig config,
                         org.mule.extension.sftp.api.FileSystem fileSystem, String path, InputStream content,
   ...
   * @throws IllegalArgumentException if an illegal combination of arguments is supplied
   */
  protected void doCopy(org.mule.extension.sftp.api.FileConnectorConfig config, org.mule.extension.sftp.api.FileSystem fileSystem,
                        String sourcePath,
   ...
   * @throws IllegalArgumentException if an illegal combination of arguments is supplied
   */
  protected void doMove(FileConnectorConfig config, org.mule.extension.sftp.api.FileSystem fileSystem, String sourcePath,
                        String targetPath, boolean createParentDirectories, boolean overwrite, String renameTo) {
    fileSystem.changeToBaseDir();
    validatePath(targetPath, "target path");
    validatePath(sourcePath, "source path");
   ...
   */
  protected void doDelete(org.mule.extension.sftp.api.FileSystem fileSystem, @Optional String path) {
    fileSystem.changeToBaseDir();
   ...
   * @param overwrite  whether or not overwrite the file if the target destination already exists.
   */
  protected void doRename(@Connection org.mule.extension.sftp.api.FileSystem fileSystem, @Optional String path,
