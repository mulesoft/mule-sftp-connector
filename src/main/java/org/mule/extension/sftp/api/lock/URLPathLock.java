...
/**
 * A {@link org.mule.extension.sftp.api.lock.PathLock} which is based on {@link Lock locks} obtained through a
 * {@link #lockFactory}. The lock's keys are generated through the external form of a {@link URL}
 *
 * @since 1.0
 */
