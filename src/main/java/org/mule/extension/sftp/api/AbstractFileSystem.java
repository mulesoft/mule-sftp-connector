...
/**
 * Base class for implementations of {@link org.mule.extension.sftp.api.FileSystem}
 *
 * @since 1.0
 */
public abstract class AbstractFileSystem<A extends org.mule.extension.sftp.api.FileAttributes> implements FileSystem<A> {
   ...
   */
  @Override
  public void copy(org.mule.extension.sftp.api.FileConnectorConfig config, String sourcePath, String targetDirectory,
                   boolean overwrite,
