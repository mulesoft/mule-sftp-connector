 ...
 * <p>
 * This interface acts as a facade which allows performing common file operations for files outside a local disk, like in a an FTP
 * server, a cloud storage service, etc, and uses {@link URI} to identify files.
 *
 * @since 1.3.0
 */
