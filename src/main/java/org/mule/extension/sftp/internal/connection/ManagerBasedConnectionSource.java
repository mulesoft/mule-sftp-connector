...
/**
 * Implementation of {@link ConnectionSource} that uses a {@link FileConnectorConfig} and a {@link ConnectionManager} to ask for
 * connections. It is necessary that all instances of this class release all the connections that it asked for.
 */
