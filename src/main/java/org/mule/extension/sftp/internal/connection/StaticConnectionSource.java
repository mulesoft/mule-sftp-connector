...
/**
 * Implementation of {@link ConnectionSource} that is based on an instance of {@link FileSystem}, it will always return the same
 * instance when calling {@link ConnectionSource#getConnection()} and it will do nothing when calling
 * {@link ConnectionSource#releaseConnection()}
 */
