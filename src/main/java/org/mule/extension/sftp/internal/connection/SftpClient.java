...
public class SftpClient {
  ...
  private String executePWDCommandWithTimeout() throws IOException {
    ...
    try {
      Scheduler getHomeScheduler = schedulerService.cpuLightScheduler(SchedulerConfig.config()
          .withShutdownTimeout(PWD_COMMAND_EXECUTION_TIMEOUT, PWD_COMMAND_EXECUTION_TIMEOUT_UNIT));
