 ...
 * {@link FileSystem} in order to get the file attributes and the file content. This class implements the logic to retrieve and
 * release the needed fileSystems, and the developer will be given the fileSystem to get the attributes and contents without to
 * worry about how to get and retrieve connections.
 *
...
public abstract class AbstractConnectedFileInputStreamSupplier<T extends FileSystem>
  ...
  protected AbstractConnectedFileInputStreamSupplier(org.mule.extension.sftp.api.FileAttributes attributes,
  ...
  protected final org.mule.extension.sftp.api.FileAttributes getUpdatedAttributes() {
    try {
      ...
      releaseConnection();
      if (updatedFileAttributes == null && LOGGER.isErrorEnabled()) {
  ...
  /**
   * If the content of the file was retrieved, this method will return the {@link FileSystem} used to retrieve that content.
   *
