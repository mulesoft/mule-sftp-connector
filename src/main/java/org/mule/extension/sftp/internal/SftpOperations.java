...
public final class SftpOperations extends BaseFileSystemOperations {
  ...
  private static final Logger LOGGER = getLogger(SftpOperations.class);
  ...
  public void write(@Config FileConnectorConfig config, @Connection FileSystem fileSystem,
    ...
    if (encoding != null) {
      LOGGER
          .warn("Deprecated parameter 'encoding' was configured for operation 'sftp:write'. This parameter will be ignored, not altering the operation behavior");
    }
